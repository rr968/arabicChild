...
import 'package:arabic_speaker_child/model/content.dart';
import 'package:arabic_speaker_child/model/library.dart';
...
List<lib> chooseLibrary = [
  lib("المستشفى", "assets/7ss.png", "yes", [
    Content("عندي ألم في بطني", "assets/images/stomach-ache.png", "yes", "", "",
        "yes"),
    Content(
        "عندي ألم في رجلي", "assets/images/legPain.png", "yes", "", "", "yes"),
    Content(
        "عندي ألم في يدي", "assets/images/injury.png", "yes", "", "", "yes"),
    Content(
        "عندي ألم في رأسي", "assets/images/headache.png", "yes", "", "", "yes"),
    Content("إرفع يدي", "assets/images/raiseHand.png", "yes", "", "", "yes"),
    Content("إرفع رجلي", "assets/images/fitness.png", "yes", "", "", "yes"),
    Content("حرك الوسادة فوق", "assets/images/move5.png", "yes", "", "", "yes"),
    Content(
  ...
  lib("العمل", "assets/2ss.png", "yes", [
    ...
    Content("أريد السكرتير ", "assets/secretary (1).png", "yes", "", "", "yes"),
  ...
  lib("السوق", "assets/3ss.png", "yes", [
    ...
    Content("أريد خضراوات طازجة", "assets/vegetable.png", "yes", "", "", "yes"),
  ...
  lib("السفر", "assets/4ss.png", "yes", [
    Content("الأجواء معتدلة وممتعة هنا", "assets/happiness.png", "yes", "", "",
        "yes"),
    Content(
        "أريد أن أحجز تذكرة", "assets/plane-ticket.png", "yes", "", "", "yes"),
    ...
    Content("هل بوابة الرحلة مفتوحة؟", "assets/gate.png", "yes", "", "", "yes"),
  ...
  lib("المطعم", "assets/6ss.png", "yes", [
    Content("كم سعر هذه الوجبة؟", "assets/inflation.png", "yes", "", "", "yes"),
    ...
    Content("أريد الباقي لوسمحت", "assets/payment-method.png", "yes", "", "",
        "yes"),
    Content("أبحث عن مطعم شعبي قريب من هنا", "assets/restaurant (1).png", "yes",
        "", "", "yes"),
    Content(
        "من فضلك إقرأ قائمة الطعام لي", "assets/menu.png", "yes", "", "", "yes")
  ]),
  lib("المسجد", "assets/8ss.png", "yes", [
    Content("هل قامت الصلاة", "assets/shalat.png", "yes", "", "", "yes"),
    Content(
        "أريد ان اتوضأ أين المواضئ ", "assets/wudhu.png", "yes", "", "", "yes"),
