                              ...
                              children: <Widget>[
                                ExpansionTile(
                                  ...
                                  onExpansionChanged: (bool expanding) =>
                                      setState(() => isExpanded1 = expanding),
                                ),
                                ExpansionTile(
                                  title: Row(
                                    children: [
                                              ...
                                              leading: Radio(
                                                ...
                                                onChanged: (v) async {
                                                  SharedPreferences pref =
                                                      await SharedPreferences
                                                          .getInstance();
                                                  pref.setInt("noteVoiceIndex",
                                                      v as int);
                                                  final player = AudioPlayer();
                                                  await player
                                                      .setAsset(noteVoices[0]);
                                                  player.play();
                                                  setState(() {
                                                    radiovalue4 = v;
                                                    notevoiceindex =
                      ...
                      if (await internetConnection()) {
                        ...
                        removeAllSharedPrefrences().then((value) {
                          if (myInfo.isNotEmpty) {
                            myLoginInfo.setStringList("myLoginInfo", myInfo);
                          }
                          Navigator.pushAndRemoveUntil(
                              context,
                              MaterialPageRoute(
