...
import 'package:arabic_speaker_child/childpage/parent/rearrangeLib.dart';

import '../../view/export_and_import/import.dart';
import '../../controller/constantLibraryChild.dart';

import 'package:arabic_speaker_child/childpage/parent/mainparent.dart';
import 'package:arabic_speaker_child/controller/editWordLibrary.dart';
                              ...
                              builder: (context) {
                                return AlertDialog(
                                  ...
                                  title: Column(
                                    children: [
                                      SizedBox(
                                        height: DeviceUtil.isTablet ? 40 : 25,
                                        child: Stack(children: [
                                          Center(
                                            child: Text(
                            ...
                            child: Column(
                              children: [
                                ElevatedButton(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        decoration: BoxDecoration(
                                                                            ...
                                                                            color: const Color.fromARGB(255, 255, 255, 255) // Color.fromARGB(255, 121, 161, 134)
                                                                                .withOpacity(.4)),
                                                                        height: DeviceUtil.isTablet
                                                                            ? 100
                                                                            : 80,
                                                                        width: DeviceUtil.isTablet
                                                                            ? 100
                                                                            : 80,
                                                                        child: getImage(Provider.of<MyProvider>(context)
                                                                            .lastimagepath
                                                                            .toString()),
                                                                      ),
                                                                    ),
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: const [
                                                                            ...
                                                                            Text(
                                                                              "صورة",
                                                                              style: TextStyle(color: Color.fromARGB(255, 132, 132, 132), fontWeight: FontWeight.w800),
                                                                            )
                                                                          ],
                                                                        ),
                                                                      ),
                                                                ...
                                                                Padding(
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    onTap:
                                                                        () async /* {
                                                                                 if (word.text
                                                                                   ...
                                                                                   libraryListChild[coloredOpenLibraryindex].contenlist.add(
                                                                                       Content(
                                                                                           controller.text,
                                                                                           Provider.of<MyProvider>(context, listen: false)
                                                                                               .lastimagepath
                                                                                   ...
                                                                                   Navigator.pushAndRemoveUntil(
                                                                                       context,
                                                                                       MaterialPageRoute(builder: (context) => const MainParentSettings()),
                                                                                           (route) => false);
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child:
                                                                          Center(
                                                                        child: Provider.of<MyProvider>(context, listen: true).isloading
                                                                            ? const CircularProgressIndicator()
                                                                            : FittedBox(
                                                                                child: Text(
                                                                                  "حفظ",
                                                                                  style: TextStyle(color: Colors.white, fontSize: DeviceUtil.isTablet ? 25 : 20),
                                                                                ),
                                                                              ),
                                                                      ),
                                                                    ),
                                    ...
                                    child: const Text(" جملةإضافة")),
                                ElevatedButton(
                                    onPressed: () {},
                                    child: const Text("حذف الجملة")),
                                ElevatedButton(
                                    onPressed: () {
                                      Navigator.push(
                                          context,
